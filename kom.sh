...
aria2c https://transfer.sh/iVHafO/psy.MOV
...
echo "::group::Kompres"
[[ -n "$FILEPATH1" ]] && ffmpeg -i $FILEPATH1 -c:v libx264 -preset medium -tune film -crf 20 -vf scale=720:-2 -c:a copy "$NAME1"-Comp.mp4
